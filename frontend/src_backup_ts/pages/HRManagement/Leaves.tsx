          ...
          <Tab
            className={({ selected }) =>
              classNames(
                ...
                "ring-white ring-opacity-60 ring-offset-2 ring-offset-brand-500 focus:outline-none focus:ring-2",
                selected
        ...
        <Tab.Panels>
          ...
          <Tab.Panel className="rounded-sm border border-stroke bg-white p-6 shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <form onSubmit={handleApplySubmit}>
              ...
              <div className="flex justify-end gap-4.5">
                ...
                <button
                  className="flex justify-center rounded bg-brand-500 py-2 px-6 font-medium text-white hover:bg-opacity-90"
                  type="submit"
                >
                  Submit Request
                </button>
          ...
          <Tab.Panel className="space-y-4">
            {requests.map((req) => (
              <div
                key={req.id}
                className="rounded-sm border border-stroke bg-white p-6 shadow-default dark:border-strokedark dark:bg-boxdark animate-fade-in-up"
              >
                    ...
                    {req.status === "Pending" && (
                      <div className="flex gap-2">
                        <button
                          ...
                          className="rounded border border-error-500 py-1.5 px-4 text-sm font-medium text-error-500 hover:bg-error-50 dark:hover:bg-error-500/10"
                        >
                          Reject
                        </button>
                        <button
                          onClick={() => handleAction(req.id, "Approved")}
                          className="rounded bg-success-500 py-1.5 px-4 text-sm font-medium text-white hover:bg-opacity-90"
                        >
                          Approve
                        </button>
                      </div>
