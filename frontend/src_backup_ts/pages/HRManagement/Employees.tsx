        ...
        <div className="flex gap-4">
          <div className="relative">
            <input
              ...
              className="w-full rounded-lg border border-stroke bg-transparent py-2 pl-6 pr-10 outline-none focus:border-brand-500 focus-visible:shadow-none dark:border-strokedark dark:bg-meta-4 dark:focus:border-brand-500"
              value={searchTerm}
          ...
          <Link
            to="/hr/employees/add"
            className="flex items-center gap-2 rounded bg-brand-500 px-4 py-2 font-medium text-white hover:bg-opacity-90"
          >
            <svg
        ...
        <Table>
          ...
          <TableBody>
            {filteredEmployees.map((emp) => (
              <TableRow key={emp.id} className="border-b border-stroke dark:border-strokedark">
                <TableCell className="min-w-[220px] py-4.5 px-4 pl-9 xl:pl-11">
                  <div className="flex items-center gap-3 p-2.5 xl:p-5">
                    <div className="flex-shrink-0">
                      {emp.avatar ? (
                        <img src={emp.avatar} alt="avatar" className="h-10 w-10 rounded-full" />
                      ) : (
                        <div className="flex h-10 w-10 items-center justify-center rounded-full bg-meta-2 text-brand-500 dark:bg-meta-4">
                          {emp.name.charAt(0)}
                        </div>
                      )}
                    </div>
                ...
                <TableCell className="py-4.5 px-4">
                  <div className="flex items-center space-x-3.5">
                    <button className="hover:text-brand-500">
                      ...
                      >
                        <path
                          d="M8.99981 9.00016C9.99392 9.00016 10.7998 8.19427 10.7998 7.20016C10.7998 6.20605 9.99392 5.40015 8.99981 5.40015C8.0057 5.40015 7.1998 6.20605 7.1998 7.20016C7.1998 8.19427 8.0057 9.00016 8.99981 9.00016Z"
                          fill=""
                        />
                        <path
                          d="M8.99981 13.9999C12.3135 13.9999 15.352 12.0001 16.7143 8.99992C15.352 5.99971 12.3135 4.00008 8.99981 4.00008C5.68612 4.00008 2.64761 5.99971 1.28534 8.99992C2.64761 12.0001 5.68612 13.9999 8.99981 13.9999ZM8.99981 5.25008C9.96631 5.25008 10.7498 6.03358 10.7498 7.00008C10.7498 7.96658 9.96631 8.75008 8.99981 8.75008C8.03331 8.75008 7.24981 7.96658 7.24981 7.00008C7.24981 6.03358 8.03331 5.25008 8.99981 5.25008Z"
                          fill=""
                        />
                      </svg>
                    </button>
