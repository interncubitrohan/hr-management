      ...
      <div className="rounded-sm border border-stroke bg-white p-5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
        ...
        <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            <div className="w-full sm:w-48">
              <Select options={departmentOptions} placeholder="Filter by Department" onChange={setDepartmentFilter} className="bg-white dark:bg-boxdark"/>
            </div>
            <div className="w-full sm:w-48">
              <Select options={genderOptions} placeholder="Filter by Gender" onChange={setGenderFilter} className="bg-white dark:bg-boxdark"/>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-full overflow-x-auto">
          <Table>
            ...
            <TableBody>
              {filteredData.length > 0 ? (filteredData.map((record) => (<TableRow key={record.id} className="border-b border-stroke dark:border-strokedark">
