            ...
            <form onSubmit={handleSubmit}>
              <div className="p-6.5">
                <div className="mb-4.5">
                  ...
                  <Select options={incidentTypes} placeholder="Select Type" className="bg-transparent" onChange={(val) => setFormData({ ...formData, type: val })}/>
                </div>
                ...
                <div className="mb-4.5">
                  ...
                  <Select options={severityOptions} placeholder="Select Severity" className="bg-transparent" onChange={(val) => setFormData({ ...formData, severity: val })}/>
                </div>
                ...
                <div className="mb-4.5">
                  ...
                  <InputField type="date" id="date" value={formData.date} onChange={(e) => setFormData({ ...formData, date: e.target.value })}/>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <TextArea id="description" rows={4} placeholder="Describe the incident details..." className="w-full rounded-lg border border-stroke bg-transparent py-3 px-5 text-black outline-none transition focus:border-brand-500 active:border-brand-500 disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-brand-500" value={formData.description} onChange={(val) => setFormData({ ...formData, description: val })}/>
                </div>

                <button type="submit" className="flex w-full justify-center rounded bg-brand-500 p-3 font-medium text-gray hover:bg-opacity-90">
                  Submit Report
                </button>
              </div>
            </form>
          ...
          <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div className="max-w-full overflow-x-auto p-4">
              <Table>
                ...
                <TableBody>
                  {incidents.map((incident) => (<TableRow key={incident.id} className="border-b border-stroke dark:border-strokedark">
