...
export default function Documents() {
    ...
    const getFileIcon = (type) => {
        if (type === "image") {
            return (<svg className="fill-current text-brand-500" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          <path d="M21 19V5C21 3.9 20.1 3 19 3H5C3.9 3 3 3.9 3 5V19C3 20.1 3.9 21 5 21H19C20.1 21 21 20.1 21 19ZM8.5 13.5L11 16.51L14.5 12L19 18H5L8.5 13.5Z"/>
        </svg>);
        }
        return (<svg className="fill-current text-gray-500" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    return (<div className="mx-auto max-w-7xl">
      ...
      <div className="mb-6 rounded-sm border border-stroke bg-white p-6 shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="mb-4 max-w-md">
          ...
          <Select options={documentTypes} onChange={(val) => setSelectedType(val)} className="bg-white dark:bg-boxdark" defaultValue={selectedType}/>
        </div>

        <div {...getRootProps()} className={`flex flex-col items-center justify-center rounded-lg border-2 border-dashed p-10 outline-none transition-colors ${isDragActive
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="p-4">
          <div className="flex flex-col gap-4">
            {docs.map((doc) => (<div key={doc.id} className="flex flex-col gap-4 rounded-lg border border-stroke bg-gray-50 p-4 transition hover:bg-gray-100 dark:border-strokedark dark:bg-meta-4/20 dark:hover:bg-meta-4/40 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div className="relative h-14 w-14 min-w-[56px] overflow-hidden rounded-md border border-stroke bg-white dark:border-strokedark dark:bg-boxdark sm:h-16 sm:w-16">
                    {doc.preview ? (<img src={doc.preview} alt={doc.name} className="h-full w-full object-cover"/>) : (<div className="flex h-full w-full items-center justify-center">
                ...
                <div className="flex items-center gap-4 sm:gap-6">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <button className="text-gray-500 hover:text-error-500 dark:text-gray-400 dark:hover:text-error-400" onClick={() => {
            ...
            {docs.length === 0 && (<div className="p-8 text-center text-gray-500 dark:text-gray-400">
