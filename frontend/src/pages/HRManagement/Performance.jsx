...
const StarRating = ({ rating }) => {
    return (<div className="flex items-center space-x-1">
      {[1, 2, 3, 4, 5].map((star) => (<svg key={star} className={`h-5 w-5 ${star <= rating ? "fill-warning text-warning" : "fill-gray-300 text-gray-300"}`} viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    ...
    return (<div className="mx-auto max-w-7xl">
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="p-6 flex flex-col gap-6">
          {mockReviews.map(review => (<div key={review.id} className="border-b border-stroke last:border-0 pb-6 last:pb-0 dark:border-strokedark">
